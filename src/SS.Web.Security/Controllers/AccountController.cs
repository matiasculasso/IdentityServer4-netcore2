...
using SS.Web.Security.Models.Account;
using SS.Web.Security.UserServices;
...
namespace SS.Web.Security.Controllers
{
    ...
    /// This data store is in-memory only and cannot be used for production!
    ...
    public class AccountController : Controller
    {
	    ...
	    //TestUserStore is for test purposes only, It must be replaced by your Identity Manager library
            ...
            )
        {
			...
			_testUsers = new TestUserStore(TestUsers.Users);
        }
        ...
        private (TestUser user, string provider, string providerUserId, IEnumerable<Claim> claims) FindUserFromExternalProvider(AuthenticateResult result)
        {
            ...
            // find external user
            var user = _testUsers.FindByExternalProvider(provider, providerUserId);
        ...
        {
            var user = _testUsers.AutoProvisionUser(provider, providerUserId, claims.ToList());
            return user;
        }
